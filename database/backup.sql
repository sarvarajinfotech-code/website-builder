...
INSERT INTO `clients` VALUES (13,'Vercel','/client_logo_13.png'),(14,'AWS','/client_logo_14.png'),(15,'Microsoft','/client_logo_15.png'),(16,'Netflix','/client_logo_16.png'),(18,'Adobe','/client_logo_18.png'),(19,'demo','/client_logo_19.png');
...
CREATE TABLE `meeting` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `SHOW_MEETING` tinyint(1) NOT NULL,
...
INSERT INTO `meeting` VALUES (1,1,'Set up meeting with us','https://calendly.com/babureddys003/30min');
...
INSERT INTO `pages` VALUES (14,'demo','nothing','<p>This HTML email template includes the following features:</p><p><br></p><ul><li>1. A responsive design that works well on both desktop and mobile devices.</li><li>2. Inline CSS for better compatibility across different email clients.</li><li>3. A clean and professional layout with a header, main content, and footer.</li><li>4. A placeholder for the subscriber\'s email address ({USER_EMAIL}) that you can replace with the actual email address when sending the notification.</li></ul><p><br></p><p><br></p><p>To use this template:</p><p><br></p><p>1. Save the HTML code in a file (e.g., `subscription-notification.html`).</p><p>2. When a new user subscribes, replace the `{{USER_EMAIL}}` placeholder with the actual email address of the subscriber.</p><p>3. Use an email sending service or library in your backend to send this HTML email to the admin\'s email address.</p><p><br></p><p><br></p><p>Remember to test the email template across different email clients to ensure it displays correctly. Some email clients may have limitations on CSS support, so keeping the design simple and using inline CSS helps maintain consistency across platforms.</p>');
...
INSERT INTO `price_plan_type` VALUES (12,'Starter'),(13,'Small Business'),(16,'Enterprise');
...
INSERT INTO `users` VALUES (6,'demo.admin@gmail.com','$2b$12$oKonfsulUuszR3wbLTSf1OgfRZclOjaoRZaiWdpyXJVYguoM0f6nK','admin');
...
-- Dump completed on 2025-02-03 20:29:39
