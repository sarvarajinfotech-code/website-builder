...
class HomePageSettingsModel(Base):
    ...
    HEADER_TEXT_ALIGNMENT = Column(Enum('left', 'right', 'center'), default='left')
    TAGLINE_TEXT = Column(String(255), nullable=True)
    TAGLINE_ALIGNMENT = Column(Enum('left', 'right', 'center'), default='left')
    ...
    SECONDARY_BUTTON_TYPE = Column(Enum('video', 'link'), default='link')
