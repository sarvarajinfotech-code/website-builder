...
def create_team_member(db: Session, employee_name: str, designation: str, linkedin_profile: str, twitter_profile: str, youtube_profile: str, facebook_profile: str, twitterX_profile: str, photo_path: str):
    new_team_member = TeamModel(
        ...
        TWITTERX_PROFILE=twitterX_profile,
...
def update_team_member(db: Session, team_id: int, employee_name: str, designation: str, linkedin_profile: str, twitter_profile: str, youtube_profile: str, facebook_profile: str, twitterX_profile: str, photo_path: str):
    ...
    if team_member:
        ...
        team_member.YOUTUBE_PROFILE = youtube_profile
        team_member.FACEBOOK_PROFILE = facebook_profile
        team_member.TWITTERX_PROFILE = twitterX_profile
